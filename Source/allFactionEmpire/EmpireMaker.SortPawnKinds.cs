...
namespace empireMaker {
    public partial class EmpireMaker {
        public static void SortPawnKinds(ConversionSettings settings, FactionDef factionDef,
        ...
        public static void SortFighterPawnKinds(ConversionSettings settings, FactionDef factionDef,
        ...
        public static void SortPermitPawns(ConversionSettings settings, FactionDef factionDef, 
